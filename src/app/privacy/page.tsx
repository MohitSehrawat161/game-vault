  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black py-12 px-4 md:px-0 font-orbitron">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-4xl md:text-5xl font-bold text-cyan-400 mb-10 text-center">Privacy Policy</h1>
        {/* Introduction */}
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside text-gray-300 space-y-1">
            ...
            <li><span className="font-semibold text-neon-green">Purchase Activity:</span> Details about the games, accessories, or merch you buy, plus your order history and preferences.</li>
          </ul>
        </section>
        <div className="border-b border-gray-700 mb-8" />
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside text-gray-300 space-y-1">
            ...
            <li><span className="font-semibold text-neon-blue">Marketing:</span> To send you news, deals, and updates (only if you opt in—no spam, promise!).</li>
            <li><span className="font-semibold text-neon-blue">Personalization:</span> To recommend games, skins, or gear you might like based on your activity.</li>
          </ul>
        </section>
        <div className="border-b border-gray-700 mb-8" />
        {/* Cookies & Tracking */}
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-neon-green mb-2">Third-party Services</h2>
          <p className="text-gray-300">To power up your experience, we sometimes use trusted third-party services—like payment processors (e.g., Stripe, PayPal), analytics providers (e.g., Google Analytics), and shipping partners. These services only get the info they need to do their job, and they’re required to protect your data just like we do. We recommend checking their privacy policies for more details.</p>
        </section>
        <div className="border-b border-gray-700 mb-8" />
        {/* Your Rights */}
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-neon-purple mb-2">Your Rights</h2>
          <p className="text-gray-300">You’re in control of your data. You can access, update, or delete your personal info at any time by logging into your account or contacting us. Want to opt out of marketing emails? Just hit the unsubscribe link or update your preferences. If you have questions about your rights, our support team is here to help.</p>
        </section>
        <div className="border-b border-gray-700 mb-8" />
        {/* Changes to This Policy */}
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-neon-blue mb-2">Changes to This Policy</h2>
          <p className="text-gray-300">We may update this Privacy Policy from time to time to reflect new features, legal requirements, or community feedback. When we make changes, we’ll update the date at the top of this page and let you know if it’s a big deal. We encourage you to review this policy regularly to stay informed.</p>
        </section>
        <div className="border-b border-gray-700 mb-8" />
        {/* Contact Us */}
        <section className="mb-8">
        ...
        <nav className="flex flex-wrap gap-6 justify-center mt-8">
          <Link href="/terms" className="text-neon-purple underline hover:text-neon-green font-semibold">Terms of Service</Link>
